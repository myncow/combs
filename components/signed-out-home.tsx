      ...
      <section className="grid gap-4 xl:grid-cols-[minmax(0,1.55fr)_minmax(18rem,0.85fr)]">
        <div className="border border-border bg-card p-5 md:p-7">
          <div className="flex flex-wrap items-center gap-2">
            <Badge variant="accent">Signed-out view</Badge>
          ...
          <div className="grid gap-4 px-4 py-4 md:px-5 md:py-5 lg:grid-cols-[minmax(0,1.08fr)_minmax(17rem,0.92fr)]">
            <div className="space-y-4">
              <div className="space-y-3">
                ...
                <div
                  className="flex min-h-[4rem] cursor-not-allowed items-center border border-dashed border-border/80 bg-background/55 px-3 py-3 text-[clamp(1.15rem,3vw,1.5rem)] font-medium italic leading-[1.2] tracking-[-0.03em] text-muted-foreground/72"
                  aria-hidden
                >
            ...
            <div className="grid gap-3">
              <div className="border border-border bg-background/75 p-3">
                ...
                <div className="mt-3 space-y-2 text-[13px] leading-snug text-muted-foreground">
                  <p>Live topic input and suggestion fetching</p>
                  <p>Map generation plus saved drafts in the sidebar</p>
                  <p>Publishing and voting-ready spotlight cards</p>
                </div>
              </div>
              ...
              <div className="border border-border bg-background/75 p-3">
                <div className="flex items-end justify-between gap-3">
                  ...
                  <Link
                    ...
                    className="shrink-0 font-mono text-[10px] uppercase tracking-[0.18em] text-foreground transition-colors hover:text-primary"
                  >
                    Open list
                  </Link>
                </div>
          ...
          {featured ? (
            <Link href={`/leaderboard/${featured.slug}`} className="group block">
              ...
              <div className="space-y-4 p-4 md:p-5">
                ...
                <div>
                  <h2 className="font-sans text-[24px] font-semibold leading-[1.05] tracking-[-0.025em] text-foreground">
                    {featured.storyTitle}
                  </h2>
                ...
                <div className="border-t border-border pt-4">
                  ...
                  <p className="mt-2 font-mono text-[10px] uppercase tracking-[0.18em] text-foreground transition-colors group-hover:text-primary">
                    View spotlight →
                  </p>
                </div>
              </div>
