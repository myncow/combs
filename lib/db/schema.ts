...
export const legacyGenerationRunsTable = pgTable("generation_runs", {
  id: varchar("id", { length: 64 }).primaryKey(),
  mapId: varchar("map_id", { length: 64 }),
  status: varchar("status", { length: 20 }).notNull(),
  model: varchar("model", { length: 120 }).notNull(),
...
export const legacyLeaderboardEntriesTable = pgTable(
  "leaderboard_entries",
  {
    id: varchar("id", { length: 64 }).primaryKey(),
    slug: varchar("slug", { length: 180 }).notNull().unique(),
...
export const legacyLeaderboardVotesTable = pgTable(
  "leaderboard_votes",
  {
